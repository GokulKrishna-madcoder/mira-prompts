      ...
      <div id="topbar-actions" className="topbar-actions flex items-center gap-2 shrink-0">
        {user ? (
          <>
            ...
            <FeedbackModal />
            <Link id="user-avatar" href="/settings" className="user-avatar w-10 h-10 ml-2 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center font-bold text-gray-600 hover:ring-2 hover:ring-gray-300 transition-all">
              {user.email?.charAt(0).toUpperCase() || 'U'}
            </Link>
          </>
        ) : (
          <div id="auth-buttons" className="auth-buttons flex items-center gap-2 ml-2">
