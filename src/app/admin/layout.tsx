...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div id="admin-shell" className="admin-shell flex w-full min-h-screen bg-[#F8F9FA]">
      
      {/* Premium Sidebar */}
      <aside 
        id="admin-sidebar" 
        className="admin-sidebar w-[280px] shrink-0 bg-gradient-to-b from-[#FAFAFA] via-white to-[#F8F9FA] border-r border-gray-200/60 flex flex-col shadow-[4px_0_24px_-12px_rgba(0,0,0,0.05)] z-20 sticky top-0 h-screen"
      >
        
        {/* Header */}
        <div id="admin-sidebar-header" className="admin-sidebar-header p-6 pt-8">
        ...
        <div id="admin-sidebar-footer" className="admin-sidebar-footer p-4 mt-auto mb-4 mx-4">
      ...
      <main id="admin-content" className="admin-content flex-1 overflow-y-auto bg-transparent relative">
